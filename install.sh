...
# Create default v2 flight.json (always overwrite - /flight-scan is the customization mechanism)
cat > .flight/flight.json << 'FLIGHT_JSON'
{
  "version": "2",
  "generated": "auto-generated by install.sh",
  "scan_root": ".",
  "paths": {
    "source": [],
    "test": [],
  ...
  "detection_log": {
    ...
    "note": "Run /flight-scan to detect project-specific domains"
  }
}
FLIGHT_JSON
...
echo ""
echo "┌─────────────────────────────────────────────────────────────────┐"
echo "│  NEXT STEP: Run /flight-scan in Claude Code                    │"
echo "│                                                                 │"
echo "│  This detects your project's tech stack (TypeScript, React,    │"
echo "│  Next.js, etc.) and enables the appropriate domain validators. │"
echo "│                                                                 │"
echo "│  NOTE: /flight-scan is a Claude Code skill - it MUST be run    │"
echo "│  inside Claude Code, not in a regular terminal.                │"
echo "└─────────────────────────────────────────────────────────────────┘"
echo ""
echo "Local CI:"
...
echo "  /flight-scan      - Detect project domains (run this first!)"
